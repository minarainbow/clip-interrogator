...
class Interrogator():
    ...
    def load_clip_model(self):
        ...
        self.styles = LabelTable(_load_list(config.data_path, 'styles.txt'), "styles", self.clip_model, self.tokenize, config)
        self.lighting = LabelTable(_load_list(config.data_path, 'lighting.txt'), "lighting", self.clip_model, self.tokenize, config)
        self.perspective = LabelTable(_load_list(config.data_path, 'perspective.txt'), "perspective", self.clip_model, self.tokenize, config)
